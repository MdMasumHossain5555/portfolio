...
function ContractSection() {
  return (
    <div className='w-[95%] text-center p-10 pb-10 border border-border rounded-md mx-auto mt-10 shadow-foreground/20 shadow-lg backdrop-blur-sm'>
            ...
            <a href="/contact"><button className='btn-primary inline-flex items-center justify-center text-foreground px-6 py-2 rounded-md hover:bg-secondary hover:text-primary transition-colors duration-300 whitespace-nowrap'>Get In Touch<ArrowRight className='ml-2' /></button></a>
        </div>
  )
}
